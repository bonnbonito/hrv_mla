...
form.newserachform .datepicker-input.in-edit:active,
form.newserachform .datepicker-input.in-edit:focus {
...
@media (max-width: 1024px) {
	...
	.newserachform .form-field:nth-child(1) input,
	.newserachform .form-field:nth-child(2) input {
		border-bottom: 1px solid #ddd;
	}
}
</style>
...
<form id="searchVillaForm" action="<?php bloginfo( 'url' ); ?>/villa-list-result" method="GET" autocomplete="off"
	...
	<div class="form-field">
		...
		<input type="text" name="date_checkout" id="check-out"
			value="<?php echo ( isset( $_REQUEST['date_checkout'] ) ? $_REQUEST['date_checkout'] : '' ); ?>"
			placeholder=" ">
	...
	<div class="form-field form-field-select">
		...
		<div class="div-select-wrap <?php echo ( isset( $_REQUEST['bedrooms'] ) ? 'focus has-value' : '' ); ?>">
			<input type="text" id="bedrooms"
				value="<?php echo ( isset( $_REQUEST['bedrooms'] ) ? $_REQUEST['bedrooms'] . ' Bedrooms' : '' ); ?>"
				required>

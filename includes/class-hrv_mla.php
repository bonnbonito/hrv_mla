...
class HRV_MLA {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'acf/save_post', $plugin_admin, 'update_booking_property_owner' );
		$this->loader->add_action( 'acf/save_post', $plugin_admin, 'update_specific_check_in_instructions' );
